...
**Fonte:** `.github/CODEOWNERS`, `code-of-conduct.md`
...
**Fonte:** `.github/pull_request_template.md`
...
**Fonte:** árvore cacheada (277 arquivos em `/rules/`), `react.mdc` (exemplo)
...
**Fonte:** `package.json`, `.github/workflows/main.yml`
...
**Fonte:** `scripts/check-repo-hygiene.mjs`, `check-awesome-list.mjs`, main.yml
...
**Fonte:** `package.json`, Glob para CHANGELOG (não encontrado)
...
**Fonte:** `.github/workflows/main.yml`, `check-repo-hygiene.mjs`
...
**Fonte:** README.md, contributing.md, code-of-conduct.md, pull_request_template.md
...
**Fonte:** README.md, code-of-conduct.md
...
**Fonte:** pull_request_template.md, ISSUE_TEMPLATE/, workflows
